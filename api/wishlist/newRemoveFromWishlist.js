...
export const useRemoveFromWishlist = () => {
  return useMutation(
    async ({ productId, userId }) => {
      if (!productId || !userId) {
        throw new Error('Product ID and User ID are required to remove from wishlist');
      }
      ...
      try {
        ...
        throw new Error(error.message || 'An error occurred while removing product from wishlist');
      }
    },
    {
      onMutate: () => {
