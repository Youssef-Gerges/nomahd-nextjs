                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xl-3 col-md-6 col-12">
                                <div className="footer-infor">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <p>
                                                Email: <a href="#">support@nomahd.com</a>
                                            </p>
                                        </li>
                                        <li>
                                            <p>
                                                Phone: <a href="#">+966537094604</a>
                                            </p>
                                        </li>
                                    </ul>
                            ...
                            <div className="col-xl-3 col-md-6 col-12 footer-col-block">
                                ...
                                <ul className="footer-menu-list tf-collapse-content">
                                    {topCategories?.data?.map((category, index) => (
                                        <li key={index}>
                                            <Link href={`/shop-collection-sub/${category?.name}/${category?.id}`} className="footer-menu_item">
                                                {category.name}
                                            </Link>
                                        </li>
                                    ))}
                            ...
                            <div className="col-xl-3 col-md-6 col-12 footer-col-block">
                                ...
                                <ul className="footer-menu-list tf-collapse-content">
                                    {topBrands?.data?.map((brand, index) => (
                                        <li key={index}>
                                            <Link href={`/shops/${brand.slug}`} className="footer-menu_item">
                                                {brand.name}
                                            </Link>
                                        </li>
                                    ))}
                            ...
                            <div className="col-xl-3 col-md-6 col-12 footer-col-block">
                                ...
                                <ul className="footer-menu-list tf-collapse-content">
                                    <li>Become A Seller <Link href={"/seller-register"} className={"fw-bold"}> Apply Now</Link></li>
                                </ul>
                            </div>
