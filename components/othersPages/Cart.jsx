            ...
            <div className="tf-cart-footer-inner">
              ...
              <div className="tf-page-cart-checkout">
                ...
                <p className="tf-cart-tax">
                  Taxes and
                  <Link className="ms-1" href={`/shipping-delivery`}>shipping</Link> calculated
                  at checkout
                </p>
                <div className="cart-checkbox">
                  ...
                  <label htmlFor="check-agree" className="fw-4">
                    I agree with the
                    <Link className="ms-1" href={`/terms-conditions`}>terms and conditions</Link>
                  </label>
                </div>
                {termsError &&  
                  <p className="text-danger mb_20">Please agree terms and conditions first</p>
                }
